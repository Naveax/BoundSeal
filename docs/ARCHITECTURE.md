# BoundSeal architecture

## Status

BoundSeal's deterministic architecture-contract program is complete through BSL-119. The codebase is organized as a deny-by-default set of typed contracts rather than a monolithic scanner.
...
- `bsl-policy`, `bsl-events`, `bsl-audit`, `bsl-budget`
- `bsl-destination`, `bsl-dns`, `bsl-gateway`

### Transport and protocol contracts

- `bsl-transport`, `bsl-pinned-transport`
- `bsl-executor`, `bsl-local-executor`
- `bsl-stream`, `bsl-stream-fixture`
- `bsl-tls`, `bsl-http1`, `bsl-http1-fixture`
- `bsl-channel-contracts`, `bsl-redirect`

### Identity and state

- `bsl-vault`, `bsl-session`, `bsl-cookie-jar`

### Analysis and planning

- `bsl-content-analysis`, `bsl-planner`
- `bsl-passive-analyzers`, `bsl-active-validation`

### Evidence and orchestration

- `bsl-knowledge-reporting`
- `bsl-workflow-graph`
- `bsl-adapter-boundary`, `bsl-replay-lab`
- `bsl-release-governance`, `bsl-platform-assurance`
- `bsl-lifecycle-governance`, `bsl-post-closure-governance`

### User surface

- `bsl-core`: policy/event/destination utilities plus the deterministic system smoke demo.
...
7. Write-like tests are limited to BSL-owned objects and require cleanup proof.
...
`bsl demo-run` creates a twelve-stage, SHA-256-linked receipt:
