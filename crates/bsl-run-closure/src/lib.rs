...
pub struct TerminalRunSnapshot {
    ...
    runtime_status: OperatorRunStatus,
    maximum_depth_observed: u16,
    total_response_bytes: u64,
    evidence_bytes: u64,
    external_teardown: ExternalTeardownEvidence,
}

impl TerminalRunSnapshot {
    #[allow(clippy::too_many_arguments)]
    fn from_terminal_host(
    ...
    pub fn live_run_bundle_sha256(&self) -> &str {
        &self.live_run_bundle_sha256
    }

    pub fn runner_checkpoint_sha256(&self) -> &str {
        &self.runner_checkpoint_sha256
    }

    pub fn runtime_checkpoint_sha256(&self) -> &str {
        &self.runtime_checkpoint_sha256
    }

    pub fn external_teardown(&self) -> &ExternalTeardownEvidence {
        &self.external_teardown
    }
}
...
impl RunClosureManifest {
    #[allow(clippy::too_many_arguments)]
    pub fn build_from_terminal_host(
        plan: &UnifiedOperatorPlan,
        runner_manifest: &RunnerManifest,
        runner_checkpoint: &RunnerCheckpoint,
        runtime: &RuntimeRecovery,
        ...
        let terminal = TerminalRunSnapshot::from_terminal_host(
            plan,
            runner_manifest,
            runner_checkpoint,
            runtime,
    ...
    fn verify_shape_only(&self) -> Result<(), RunClosureError> {
        ...
        self.terminal.external_teardown.validate()?;
        self.coverage.validate()?;
        self.artifacts.validate()?;
        validate_untrusted_metadata(&self.metadata)?;
        Self::validate_untested_scope(&self.untested_scope_sha256)?;
