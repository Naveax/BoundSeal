...
`bsl-tls` is a networkless TLS peer-identity contract. It verifies synthetic handshake and certificate-chain metadata only after a permit-bound `BoundedByteStream` exists.
