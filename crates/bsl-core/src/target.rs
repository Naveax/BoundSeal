...
const CREATE_DIAGNOSTIC: DiagnosticSpec = DiagnosticSpec {
    ...
    domain: "target",
    operation: "create",
    text_prefix: "BSL-TARGET-50",
};
const LIST_DIAGNOSTIC: DiagnosticSpec = DiagnosticSpec {
    code: "BSL151-TARGET-LIST-INVALID",
    domain: "target",
    operation: "list",
    text_prefix: "BSL-TARGET-51",
};
const SHOW_DIAGNOSTIC: DiagnosticSpec = DiagnosticSpec {
    code: "BSL151-TARGET-SHOW-INVALID",
    domain: "target",
    operation: "show",
    text_prefix: "BSL-TARGET-52",
};
const DISABLE_DIAGNOSTIC: DiagnosticSpec = DiagnosticSpec {
    code: "BSL151-TARGET-DISABLE-REJECTED",
    domain: "target",
    operation: "disable",
    text_prefix: "BSL-TARGET-53",
};
const VALIDATE_DIAGNOSTIC: DiagnosticSpec = DiagnosticSpec {
    code: "BSL151-TARGET-VALIDATE-INVALID",
    domain: "target",
    operation: "validate",
    text_prefix: "BSL-TARGET-54",
};
